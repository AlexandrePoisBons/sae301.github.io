...
public class PRNord extends JPanel {
	...
	public PRNord(PanelRessources panelMere){
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.insets = new Insets(0, 0, 5, 5); // Marge entre les composants
		...
		gbc.gridx = 3;
		gbc.insets = new Insets(0, 0, 5, 10); // Marge entre les composants
        ...
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.insets = new Insets(0, 10, 5, 0); // Marge entre les composants
