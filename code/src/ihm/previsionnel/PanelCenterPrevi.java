...
public class PanelCenterPrevi extends JPanel {
	...
	public PanelCenterPrevi(FrameAccueil frameAccueil) {
		...
		JPanel semestre1 = remplissagePanel(new JPanel(), this.tabTextFieldsS1[0], this.tabTextFieldsS1[1],
				this.tabTextFieldsS1[2], this.tabTextFieldsS1[3], this.tabModules[0]);
		JPanel semestre2 = remplissagePanel(new JPanel(), this.tabTextFieldsS2[0], this.tabTextFieldsS2[1],
				this.tabTextFieldsS2[2], this.tabTextFieldsS2[3], this.tabModules[1]);
		JPanel semestre3 = remplissagePanel(new JPanel(), this.tabTextFieldsS3[0], this.tabTextFieldsS3[1],
				this.tabTextFieldsS3[2], this.tabTextFieldsS3[3], this.tabModules[2]);
		JPanel semestre4 = remplissagePanel(new JPanel(), this.tabTextFieldsS4[0], this.tabTextFieldsS4[1],
				this.tabTextFieldsS4[2], this.tabTextFieldsS4[3], this.tabModules[3]);
		JPanel semestre5 = remplissagePanel(new JPanel(), this.tabTextFieldsS5[0], this.tabTextFieldsS5[1],
				this.tabTextFieldsS5[2], this.tabTextFieldsS5[3], this.tabModules[4]);
		JPanel semestre6 = remplissagePanel(new JPanel(), this.tabTextFieldsS6[0], this.tabTextFieldsS6[1],
				this.tabTextFieldsS6[2], this.tabTextFieldsS6[3], this.tabModules[5]);
	...
	public JPanel remplissagePanel(JPanel global, JTextField textFieldGpTD, JTextField textFieldGpTP,
			JTextField textFieldNbEt, JTextField textFieldNbSemaine, JTable tabModule) {
